...
1. Переписать уже имеющиеся тесты проекта PrestaShop на PageObject паттерн
2. Добавить автотесты на следующие сценарии:
    - Добавление нового товара в разделе администратора
    - Удаление товара из списка в разделе администратора
    - Регистрация нового пользователя в магазине PrestaShop
    - Переключение валют из верхнего меню PrestaShop
